...
export const LessonView: React.FC<Props> = ({ 
  ...
  // AI IMAGE NOTES VIEWER
  if (content.type === 'NOTES_IMAGE_AI') {
      return (
          <div className="fixed inset-0 z-50 bg-black flex flex-col animate-in fade-in">
              <header className="bg-black/50 backdrop-blur-md text-white p-4 absolute top-0 left-0 right-0 z-10 flex items-center justify-between">
                  <div>
              ...
              <div className="flex-1 overflow-y-auto bg-black flex flex-col items-center">
                  ...
                  <div className="h-20 bg-black w-full flex items-center justify-center">
                      <p className="text-xs text-slate-500">End of Notes</p>
                  </div>
              </div>
          </div>
      );
