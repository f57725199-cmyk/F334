...
export interface SystemSettings {
  ...
  // LESSON UNLOCKING
  lessonUnlockPolicy?: 'ALL_OPEN' | 'SEQUENTIAL_100_MCQ'; // NEW: Lesson Locking Mode
}
...
export type StudentTab = 'HOME' | 'SESSION' | 'COURSES' | 'ROUTINE' | 'CHAT' | 'HISTORY' | 'REDEEM' | 'PREMIUM' | 'GAME' | 'WEEKLY_TEST' | 'PROFILE' | 'LEADERBOARD' | 'STORE' | 'VIDEO' | 'PDF' | 'MCQ' | 'ANALYTICS' | 'PRIZES' | 'REWARDS';
